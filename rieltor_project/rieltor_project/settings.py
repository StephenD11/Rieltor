"""
Django settings for rieltor_project project.
...
print(env('SECRET_KEY'))  # Для отладки
# Получение SECRET_KEY из .env
...
ROOT_URLCONF = 'rieltor_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'rieltor' / 'templates', ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'rieltor_project.wsgi.application'
